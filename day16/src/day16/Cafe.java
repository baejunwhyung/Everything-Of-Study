...
public class Cafe {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			System.out.print("주문할 메뉴번호를 입력하세용~:");
			...
			count++;
			System.out.println("주문한 메뉴는"+menuName+"입니당~!");
			System.out.println(menuPrice+"원입니당~");
			}
			else if(num==2) {
				...
				System.out.println("결제할 급액:"+total+"원");
				System.out.print("지불할 금액:");
				int money=sc.nextInt();
				if(money<total) {
					System.out.println("잔돈이 부족해용,,");
					continue;
				}
				else {
